...
namespace SentimentAnalysisConsoleApp
{
    internal static class Program
    {
        ...
        {
            Console.WriteLine("Please Wait for ML Model to get itself trained");
            ...
            do 
            { 
                Console.WriteLine("Enter your Sentiment:");
            
            // TRY IT: Make a single test prediction, loading the model from .ZIP file
            
                SentimentIssue sampleStatement = new SentimentIssue { Text = Console.ReadLine() };
                ...
                Console.WriteLine($"================Hit 1 to continue & 0 to exit==================================");
